      ...
      <section className="home-statistics">
        <div className="home-content">
          <div className="home-stat">
            <h3 className="home-header">$1.69M</h3>
          ...
          <div className="home-stat1">
            <h3 className="home-header01">Multiverse</h3>
      ...
      <section className="home-slider">
        <div className="home-header03">
          <h2 className="home-heading">
            ...
            <span className="home-text18">o</span>
                ...
                <div data-role="current-banner" className="banner">
                  ...
                  <div className="home-content01">
                    <div className="home-header04">
                      <h3 className="home-heading01">Metaverse</h3>
    ...
    enableAutoplay: true,
      ...
      <section className="home-objectives">
        <div className="home-content05">
          <span className="home-text25">Objectives</span>
          <div className="home-objectives-list">
            <div className="objective">
              <h3 className="home-text26">Growth</h3>
            ...
            <div className="objective home-objective1">
              <h3 className="home-text28">Develop</h3>
            ...
            <div className="objective home-objective2">
              <h3 className="home-text30">Optimize</h3>
          ...
          <div className="home-header09">
            <div className="home-header10">
              <h2 className="home-heading06">
                ...
                <span className="home-text33">growth.</span>
                <br></br>
              </h2>
            </div>
        ...
        <div className="home-content10">
          <div className="home-header13">
            <h2 className="home-heading08">
              ...
              <span className="home-text46">environment</span>
              <span> now!</span>
              <br></br>
            </h2>
          </div>
              ...
              <div className="home-column2">
                ...
                <div className="home-list">
                  ...
                  <Link to="/" className="home-navlink03">
                    <span className="home-text84">Why</span>
                    <br></br>
                  </Link>
                </div>
              </div>
